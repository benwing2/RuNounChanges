...
local irreg_verbs = {
	...
	{"piangere"?, ...},
	{"porgere"?, ...},
	{"porre", "a\\ó+\\póngo,pósi,pósto:pòsto.stem:póne"},
	{"potere", [=[
	...
	{"rompere"?, ...},
	{"sapere", [=[
		a:e[as an auxiliary, with main verbs taking ''essere'']/-,sèppi.
		presrow:sò*,sài,sà*,sappiàmo,sapéte,sànno.
		fut:saprò.
		sub:sàppia.
		improw:sàppi:sappiàte
	...
	{"sistere", "a\\ì,+,sistìto"},
	{"tendere"?, ...},
	{"tenere", "a/tèngo#tiène,ténni.fut:terrò"},
	{"ungere"?, ...},
	{"uscire", "e/èsco.presp:+"},
	{"valere", "e:a[transitive]/vàlgo#à,vàlsi,vàlso.fut:varrò"},
	{"venire", "e/vèngo#viène,vénni,venùto.fut:verrò.presp:veniènte"},
	{"vivere", ...},
	{"volere", [=[
		a:e[as an auxiliary, with main verbs taking ''essere'']/-,vòlli.
...
local function generate_default_present_subj_principal_part(base)
...
local function generate_default_imperative_principal_part(base)
...
local function generate_default_past_historic_principal_part(base)
...
local function generate_default_future_principal_part(base)
...
local function generate_default_conditional_principal_part(base)
...
local function generate_default_past_participle_principal_part(base)
	check_not_null(base, base.verb.pp, "+", "first-singular past historic")
	return base.verb.pp
end


local function generate_default_gerund_principal_part(base)
	return iut.map_forms(base.verb.unaccented_stem, function(stem)
...
local function generate_default_present_participle_principal_part(base)
	return iut.map_forms(base.verb.unaccented_stem, function(stem)
...
local function conjugate_row(base, rowslot)
	...
	if rowconj.generate_default_principal_part then
		local function principal_part_special_case(base, form)
			local default_principal_part = rowconj.generate_default_principal_part(base)
