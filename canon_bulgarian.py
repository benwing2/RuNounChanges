...
pa = blib.init_argparser("Canonicalize Bulgarian and translit")
...
canon_links(params.save, params.verbose, params.cattype, "bg", "Bulgarian",
    "Cyrl", bg_translit, startFrom, upTo, pages_to_do=pages_to_do)
