...
function tests:test_pron()
	...
	self:check_pron("хуаця́о", "xʊɐˈtʲ͡sʲæo")
	self:check_pron("Цю́рих", "ˈtʲ͡sʲʉrʲɪx")
	self:check_pron("тайцзицюа́нь", "təjdʲ͡zʲzʲɪtʲ͡sʲʉˈanʲ")
	self:check_pron("Цзили́нь", "dʲ͡zʲzʲɪˈlʲinʲ")
	self:check_pron("будь што бу́дет", "but͡ʂʲ ʂto ˈbudʲɪt", "будь что бу́дет")
	self:check_pron("дух бодр, плоть же не́мощна", "duɣ bodr | plod͡ʐʲ ʐɨ ˈnʲeməɕːnə")
	...
	self:check_pron("Чжэцзя́н", "d͡ʐʐɨˈdʲ͡zʲzʲæn")
	...
	self:check_pron("отсю́да", "ɐtʲ͡sʲˈsʲʉdə")
	...
	self:check_pron("тро́лль", "trolʲ")
	self:check_pron("подча́с", "pɐˈt͡ɕːæs")
	...
	self:check_pron("што́-то", "ˈʂtotə", "что́-то")
	...
	self:check_pron("от я́блони", "ɐt‿ˈjæblənʲɪ")
	self:check_pron("от А́ни", "ɐt‿ˈanʲɪ")
	self:check_pron("дама́сский", "dɐˈmasːkʲɪj")
	self:check_pron("ельча́нин", "(j)ɪlʲˈt͡ɕænʲɪn")
	self:check_pron("коменда́нтский ча́с", "kəmʲɪnˈdan(t)skʲɪj ˈt͡ɕæs")
	...
	self:check_pron("скамья́", "skɐm⁽ʲ⁾ˈjæ")
	self:check_pron("славянофи́льство", "sləvʲɪnɐˈfʲilʲstvə")
	self:check_pron("сельдь", "sʲelʲtʲ")
	self:check_pron("секво́йя", "sʲɪkˈvojːə")
	self:check_pron("ро́жью", "ˈroʐjʉ")
	self:check_pron("Ю̀жно-Африка́нская Респу́блика", "ˌjʉʐnə ɐfrʲɪˈkanskəjə rʲɪˈspublʲɪkə")
	self:check_pron("Дза̀уджика́у", "ˌd͡zzaʊd͡ʐʐɨˈkaʊ")
	self:check_pron("Вели́кая Арме́ния", "vʲɪˈlʲikəjə ɐrˈmʲenʲɪjə")
	self:check_pron("Асунсьо́н", "ɐsʊn⁽ʲ⁾sʲˈjɵn")
	self:check_pron("Амударья́", "ɐmʊdɐrʲˈjæ")
	...
	self:check_pron("Вьентья́н", "vʲjɪnʲtʲˈjæn")
	...
	self:check_pron("авантю́ра", "ɐvɐnʲˈtʲʉrə")
	...
	self:check_pron("авиаотря́д", "ɐvʲɪɐɐtˈrʲæt")
	...
	self:check_pron("пти́ца-адъюта́нт", "ˈptʲit͡sə ɐdjʉˈtant")
	...
	self:check_pron("чу́ствовать", "ˈt͡ɕʉstvəvətʲ", "чу́вствовать")
