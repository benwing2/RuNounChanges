...
function tests:test_pron()
	...
	self:check_pron("сча́стье", "ˈɕːæsʲtʲjə", nil, "n")
	...
	self:check_pron("жили́ще", "ʐɨˈliɕːe", nil, "n")
	self:check_pron("ве́че", "ˈvʲet͡ɕe", nil, "n")
	self:check_pron("авторски́е", "ɐfˈtorskɪje", nil, "a")
	...
	self:check_pron("гу́ще", "ˈguɕːe", nil, "c")
	self:check_pron("досе́ле", "dɐˈsʲelʲe", nil, "adv")
	self:check_pron("та́кже", "ˈtagʐɨ", nil, "adv")
	...
	self:check_pron("о го́де", "ɐ‿ˈgodʲe", nil, "pre")
	self:check_pron("о вы́игрыше", "ɐ‿ˈvɨgrɨʂɨ", nil, "pre")
	...
	self:check_pron("об и́нее", "ɐˈb‿inʲɪje", nil, "pre")
	...
	self:check_pron("дух бодр, плоть же не́мощна", "duɣ bodr | plod͡ʑʐɨ ˈnʲeməɕːnə")
	...
	self:check_pron("введе́ние", "vʲːɪˈdʲenʲɪjə", nil, "n")
