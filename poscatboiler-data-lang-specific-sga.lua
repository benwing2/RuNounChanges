...
local noun_decls = {
	...
	["GENDER <nt>-stem"] = {
		...
		parent = "consonant-stem",
		addl = "Sound changes leading up to Old Irish deleted the underlying ''n'' in all forms.",
	},
	["<r>-stem"] = {
		gender = "masculine or feminine",
		nom_sg = "the bare stem with palatalized final ''r'' and unpalatalized preceding ''th'' (except in {{m|sga|siur||sister}}, which has {{w|Old Irish grammar#Vowel affection|u-insertion}})",
