...
positive_ending_tags = {
  u'ן': ['acc//dat|m|s|', 'def//postpositive|dat|n|s'],
  u'ען': ['acc//dat|m|s|', 'def//postpositive|dat|n|s'],
  u'עם': ['acc//dat|m|s|', 'def//postpositive|dat|n|s'],
  u'ע': ['def|nom//acc|n|s', 'nom//acc|f|s', 'all-case|p'],
  u'ער': ['nom|m|s', 'dat|f|s'],
  u'ס': ['postpositive|nom//acc|n|s'],
  u'עס': ['postpositive|nom//acc|n|s'],
}
