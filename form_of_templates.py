...
form_of_templates = [
  ...
  ("abstract noun of", {"cat": "abstract nouns"}),
  ("accusative of", {}),
  ...
  ("alternative reconstruction of", {"withfrom": True}),
  ...
  ("censored spelling of", {"withcap": True, "withdot": True, "cat": "censored spellings"}),
  ...
  ("continuative of", {"cat": "continuative verbs"}),
  ...
  # FIXME: Who changed to withdot?
  ("ellipsis of", {"withcap": True, "withdot": True, "cat": "ellipses"}),
  ...
  ("filter-avoidance spelling of", {"withcap": True, "withdot": True, "cat": "filter-avoidance spellings"}),
  ("form of", {}),
  ...
  ("standard form of", {"withcap": True, "withdot": True, "withfrom": True}),
  ("standard spelling of", {"aliases": ["stand sp"], "withcap": True, "withdot": True, "withfrom": True}),
  ...
  ("unhamzated spelling of", {"withcap": True}),
