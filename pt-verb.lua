...
! class="roa-person-number-header" style="width:12.5%" | Second-person<br />(<<tu>>)
! class="roa-person-number-header" style="width:12.5%" | Third-person<br />(<<ele>> / <<ela>> / <<você>>)
...
! class="roa-person-number-header" style="width:12.5%" | Third-person<br />(<<eles>> / <<elas>> / <<vocês>>)
|-
...
|-
! class="roa-nonfinite-header" | '''<span title="infinitivo pessoal">Personal</span>'''
| {pers_inf_1s}
| {pers_inf_2s}
| {pers_inf_3s}
| {pers_inf_1p}
...
| {pres_3p}
|-
! class="roa-indicative-left-rail" | <span title="pretérito imperfeito">Imperfect</span>
| {impf_1s}
| {impf_2s}
| {impf_3s}
| {impf_1p}
...
| {impf_3p}
|-
! class="roa-indicative-left-rail" | <span title="pretérito perfeito">Preterite</span>
| {pret_1s}
| {pret_2s}
| {pret_3s}
| {pret_1p}
...
| {pret_3p}
|-
! class="roa-indicative-left-rail" | <span title="pretérito mais-que-perfeito simples">Pluperfect</span>
| {plup_1s}
| {plup_2s}
| {plup_3s}
| {plup_1p}
...
| {fut_3p}
|-
! class="roa-indicative-left-rail" | <span title="condicional / futuro do pretérito">Conditional</span>
| {cond_1s}
| {cond_2s}
| {cond_3s}
| {cond_1p}
...
| {cond_3p}
|-
! class="roa-subjunctive-left-rail" colspan="7" | ''<span title="conjuntivo (pt) / subjuntivo (br)">Subjunctive</span>''
|-
! class="roa-subjunctive-left-rail" | <span title=" presente do conjuntivo (pt) / subjuntivo (br)">Present</span>
| {pres_sub_1s}
| {pres_sub_2s}
| {pres_sub_3s}
| {pres_sub_1p}
...
| {pres_sub_3p}
|-
! class="roa-subjunctive-left-rail" | <span title="pretérito imperfeito do conjuntivo (pt) / subjuntivo (br)">Imperfect</span>
| {impf_sub_1s}
| {impf_sub_2s}
| {impf_sub_3s}
| {impf_sub_1p}
...
| {impf_sub_3p}
|-
! class="roa-subjunctive-left-rail" | <span title="futuro do conjuntivo (pt) / subjuntivo (br)">Future</span>
| {fut_sub_1s}
| {fut_sub_2s}
| {fut_sub_3s}
| {fut_sub_1p}
...
| {imp_3p}
|-
! class="roa-imperative-left-rail" | <span title="imperativo negativo">Negative</span> (<<não>>)
| {neg_imp_2s}
| {neg_imp_3s}
| {neg_imp_1p}
| {neg_imp_2p}
...
|-
! class="roa-nonfinite-header" colspan="7" | ''<span title="particípio regular">Long past participle</span>''
|-
! class="roa-nonfinite-header" | Masculine
| colspan="3" | {pp_ms}
| colspan="3" | {pp_mp}
...
local function make_table(alternant_multiword_spec)
	...
	return require("Module:TemplateStyles")("Module:roa-verb/style.css") .. format(table_with_pronouns, forms)
end
