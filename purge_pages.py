...
parser.add_argument('--cat-subcats', help="Category whose subcategories to purge")
...
elif args.cat_subcats:
  pages_to_list = blib.cat_subcats(args.cat_subcats, start, end)
else:
